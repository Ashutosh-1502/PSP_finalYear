import OtpForm from "@/module/auth/templates/otp-form";
...
export default function OtpPage() {
    ...
    amet sint velit officia consequat duis."
		...
		>
			<p className="-mt-1 mb-9 text-center text-[15px] leading-[1.85] text-gray-700 md:text-base md:!leading-loose lg:text-start xl:-mt-6">
