...
import { NotificationsHelpers } from "@/routes/notifications/helpers";
...
export class UserRoutes {
  ...
  public static updateProfile = async (
    ...
    try {
      ...
      await NotificationsHelpers.create(req.user._id, companyRef, message);
  ...
  public static changePassword = async (
    ...
    try {
      ...
      const { error: passwordUpdateError } =
        await supabase.auth.admin.updateUserById(req.user.supabaseUserId, {
      ...
      await NotificationsHelpers.create(userId, companyRef, message);
